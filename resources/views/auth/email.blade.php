...
<html>
    <head>
        ...
        <title>Forgot Password | Qu Sys</title>
    ...
    <body class="teal">
        ...
        <div id="login-page" class="row">
                ...
                <form class="login-form" action="{{ route('post_email') }}" method="post" onsubmit="return load()">
                    ...
                    <div class="row">
                        <div class="input-field col s12 center">
                            <p class="center login-form-text" style="font-size:23px;margin-top:5px">Qu Sys</p>
            ...
            <div class="row center-align white-text" style="margin-bottom:0">
                <span>Powered by <a href="http://www.iamkarlsaycon.com" target="_blank" style="color:#ccc">KJS Media Labs</a></span>
            </div>
        </div>
