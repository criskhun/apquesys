...
<html>
    <head>
        ...
        <title><?php echo $__env->yieldContent('title'); ?> | Qu Sys</title>
    ...
    <body>
            ...
            <div class="navbar-fixed">
                <nav class="navbar-color">
                    <div class="nav-wrapper">
                        <ul class="left">
                            <li><h1 class="logo-wrapper"><a href="<?php echo e(route('dashboard')); ?>" class="brand-logo darken-1"><img src="<?php echo e(asset('assets/images/jltoken-logo.png')); ?>" alt="materialize logo"></a><span class="logo-text">Qu Sys</span></h1></li>
                        </ul>
        ...
        <footer class="page-footer" style="padding:0;margin-top:0">
            <div class="footer-copyright">
                <div class="container">
                    <span>Powered by <a class="grey-text text-lighten-3" href="http://www.iamkarlsaycon.com" target="_blank">KJS Media Labs</a> All rights reserved.</span>
